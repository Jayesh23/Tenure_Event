...
def draw_text(output, text, x, y, color=(0,0,0), thickness=10, size=3):
	if x is not None and y is not None:
		cv2.putText(output, text, (int(x), int(y)), cv2.FONT_HERSHEY_SIMPLEX, size, color, thickness)
...
while True:
	...
	# resize the frame to have a width of 1080 pixels (while
